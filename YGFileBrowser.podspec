...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YGFileBrowser.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rays77@163.com/YGFileBrowser'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rays77@163.com' => '376906177@qq.com' }
  s.source           = { :git => 'https://github.com/rays77@163.com/YGFileBrowser.git', :tag => s.version.to_s }
